...
test( "graph-spec : MultiDiGraph simple test > " + title , function ( t ) {
...
test( "graph-spec : MultiDiGraph extensive test > " + title , function ( t ) {
	...
	for ( let i of range( n ) ) {
		...
		t.true( set( map(([,v]) => v, G.incident( V[i] ) ) ).isequal(
			chain( [
		...
		t.true( set( map(([u]) => u, G.incident( V[i] ) ) ).isequal(
			chain( [
